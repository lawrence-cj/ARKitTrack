...
class TrackingSamplerRGBD(torch.utils.data.Dataset):
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                template_frames, template_depths, template_anno, meta_obj_train = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict, need_depth=True)
                search_frames, search_depths, search_anno, meta_obj_test = dataset.get_frames(seq_id, search_frame_ids, seq_info_dict, need_depth=True)
