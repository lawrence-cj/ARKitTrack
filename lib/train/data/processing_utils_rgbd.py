...
def sample_target(im, target_bb, search_area_factor, output_sz=None, mask=None):
    ...
    if mask is not None:
        mask_crop_padded = F.pad(torch.Tensor(mask_crop), pad=(x1_pad, x2_pad, y1_pad, y2_pad), mode='constant', value=0)
    ...
    if output_sz is not None:
        ...
        return im_crop_padded, resize_factor, att_mask, mask_crop_padded.numpy()
