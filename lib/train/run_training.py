...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    if distill:
        ...
        expr_module = importlib.import_module('lib.train.train_script_art')
...
def main():
    ...
    parser.add_argument('--script', type=str, required=False, help='Name of the train script.', default='art')
    parser.add_argument('--config', type=str, required=False, help="Name of the config file.", default='vitb_384_mae_ce_32x4_ep300')
    parser.add_argument('--cudnn_benchmark', type=bool, default=True, help='Set cudnn benchmark on (1) or off (0) (default is on).')
    parser.add_argument('--local_rank', default=-1, type=int, help='node rank for distributed training')
    parser.add_argument('--save_dir', type=str, help='the directory to save checkpoints and logs', default='./output')
