...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, help='training script name', default='art')
    parser.add_argument('--config', type=str, help='yaml configure file name', default='vitb_384_mae_ce_32x4_ep300')
    parser.add_argument('--save_dir', type=str, help='root directory to save checkpoints, logs, and tensorboard', default='./output')
    ...
    parser.add_argument('--nproc_per_node', type=int, help="number of GPUs per node", default=2)  # specify when mode is multiple
